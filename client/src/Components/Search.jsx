    ...
    if (!query.length) {
      ...
      const getSearchResult = async () => {
        const result = await fetchDataFromApi(
          `/api/alls?populate=*&filters[$or][0][email][$containsi]=${query}&filters[$or][1][price][$contains]=${query}&filters[$or][2][title][$contains]=${query}&filters[$or][3][artist][$contains]=${query}&filters[$or][4][category][$contains]=${query}&filters[$or][5][description][$contains]=${query}&filters[$or][6][location][$contains]=${query}`
        );
        setdata(result.data);
      };
      getSearchResult();
